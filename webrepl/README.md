> tl;dr open webrepl.html from a browser

WebREPL client for MicroPython
==============================

> from https://github.com/micropython/webrepl @ 0e1209a
> It is kept as a copy, rather than a repository, because git makes repos-within-repos difficult.
